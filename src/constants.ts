...
export const INIT_CODE_HASH: string = '0x24e2d0f445c0e078d4b6d1159eba7c098d23ef7d42cf0717386b5bacdc46bf62'
...
export const FACTORY_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.KOVAN]: '0x61072728D3f8e5fAC0450a272a56635925Db1aba',
...
export const ROUTER_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.KOVAN]: '0xCfD3634DA6Ef81A168391CD59b36e2Ef11D58d39',
...
export const SUSHI_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.KOVAN]: '0x812A2eeed6b4A9eA86CA4f5915ff546292E5F039',
...
export const MASTERCHEF_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.KOVAN]: '0x0b6f07520ce88a8f3f31Ba09f1811eC8C034f06f',
  [ChainId.FANTOM]: '0xae75A438b2E0cB8Bb01Ec1E1e376De11D44477CC',
  [ChainId.FANTOM_TESTNET]: '',
  [ChainId.MATIC]: '0x0b3F868E0BE5597D5DB7fEB59E1CADBb0fdDa50a',
  [ChainId.MATIC_TESTNET]: '',
...
export const BAR_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.KOVAN]: '0xf34244c24850f25bbbFDcA7696686b41e733cA23',
  [ChainId.FANTOM]: '',
  [ChainId.FANTOM_TESTNET]: '',
  [ChainId.MATIC]: '',
  [ChainId.MATIC_TESTNET]: '',
...
export const MAKER_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.KOVAN]: '0xb0ffF27922789B3c6975d5bf28f1452F226E8e30',
  [ChainId.FANTOM]: '',
  [ChainId.FANTOM_TESTNET]: '',
  [ChainId.MATIC]: '',
  [ChainId.MATIC_TESTNET]: '',
